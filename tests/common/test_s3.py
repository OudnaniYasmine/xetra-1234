"""Test S3BucketConnectorsMethods"""
...
class TestS3BucketConnectorMethods(unittest.TestCase): 
    ...
    def setUp(self):
        ...
        #mockin s3 connection start 
        self.mock_aws = mock_aws()  # Instanciation de l'objet mock_aws
        self.mock_aws.start()   
    ...
    def tearDown(self):
        ...
        #mockin s3 connection stop
        self.mock_aws .stop()
  
    def test_list_files_in_prefix_ok(self):
        """ Test the list_files_in_prefix method for getting 2 file keys as list on the mocket s3 bucket """
        #Expected results
        prefix_exp = 'prefix/'
