...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_traded_vol : column name for traded volum in source 
...
class XetraTargetConfig(NamedTuple) : 
    ...
    trg_col_isin : column name for isin target 
    ...
    trg_col_dail_trad_vol : column name for daily traded volum in target 
    trg_col_ch_prev_clos: column name for change to previous day's closing price in target 
    trg_key : basic key for target file
...
class XetraETL() : 
    ...
    """
    Reads the Xetra data, transform and writes the transformed to target 
